...
func Test_day1Part1(t *testing.T) {
	...
	tests := []struct {
		...
		{"part 1 test", args{path: "day1-test.txt"}, 142},
		{"part 1 answer", args{path: "day1.txt"}, 54644},
	}
...
func Test_day1Part2(t *testing.T) {
	...
	tests := []struct {
		...
		{"part 2 test", args{path: "day1-test-part2.txt"}, 281},
		{"part 2 answer", args{path: "day1.txt"}, 53348},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
