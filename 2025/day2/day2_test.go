...
func Test_day2Part1(t *testing.T) {
	...
	tests := []struct {
		...
		{"part 1 test", args{path: "day2-test.txt"}, 1227775554},
		{"part 1 answer", args{path: "day2.txt"}, 12599655151},
	}
...
func Test_day2Part2(t *testing.T) {
	...
	tests := []struct {
		...
		{"part 2 test", args{path: "day2-test.txt"}, 4174379265},
		{"part 2 answer", args{path: "day2.txt"}, 20942028255},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
